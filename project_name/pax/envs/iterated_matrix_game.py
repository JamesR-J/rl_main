...
class IteratedMatrixGame(environment.Environment):
    ...
    def __init__(self, num_inner_steps: int, num_outer_steps: int):
        ...
        def _step(
            ...
            # actions_new = (actions + 1.0) / 2.0
            # a1_new, a2_new = actions_new
            # u1 = params.payoff_matrix[0][0] - params.payoff_matrix[1][0] - params.payoff_matrix[2][0] + params.payoff_matrix[3][0]
            # u2 = params.payoff_matrix[0][1] - params.payoff_matrix[1][1] - params.payoff_matrix[2][1] + params.payoff_matrix[3][1]
            # r1_new = (a1_new * a2_new * u1 + a1_new * (params.payoff_matrix[1][0] - params.payoff_matrix[3][0]) +
            #           a2_new * (params.payoff_matrix[2][0] - params.payoff_matrix[3][0]) + params.payoff_matrix[3][0])
            # r2_new = (a1_new * a2_new * u2 + a1_new * (params.payoff_matrix[1][1] - params.payoff_matrix[3][1]) +
            #           a2_new * (params.payoff_matrix[2][1] - params.payoff_matrix[3][1]) + params.payoff_matrix[3][1])
