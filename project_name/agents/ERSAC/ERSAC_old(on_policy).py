...
class ERSACAgent(AgentBase):
    def __init__(self,
        ...
        if self.config.DISCRETE:
            ...
            self.rp_network = EnsembleNetwork(self.action_dim, config=config, agent_config=self.agent_config)
    ...
    def create_train_state(self):
        def create_ensemble_state(key: chex.PRNGKey) -> TrainState:  # TODO is this the best place to put it all?
            ...
            rp_params = self.rp_network.init(_key, self._init_x,
                                             jnp.zeros((1, self.config.NUM_ENVS, self.action_dim)))["params"],
    ...
    def _get_reward_noise(self, ens_state: TrainStateRP, obs_LNO: chex.Array, actions_LNA: chex.Array, key) -> chex.Array:
        ...
        ensembled_reward_ULN1 = jax.vmap(single_reward_noise, in_axes=(0, None, None))(ens_state, obs_LNO, actions_LNA)
